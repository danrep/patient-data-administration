CREATE PROCEDURE [dbo].[Sp_System_Indicators_PopulationDistro_NfcCount]
...
AS
	...
	INNER JOIN Patient_PatientNearFieldCommunicationData p_pbd ON p_pi.PepId = p_pbd.PepId
