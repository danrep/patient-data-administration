var handleJstreeDefault = function () {
        $("#jstree-default").jstree({
            ...
            function(e, t) {
                ...
                return "#" != a.attr("href") && "javascript:;" != a.attr("href") && "" != a.attr("href")
                    ? ("_blank" == a.attr("target") && (a.attr("href").target = "_blank"), document.location.href =
                        a.attr("href"), !1)
                    : void 0
            });
    },
                ...
                data: {
                    url: function(e) {
                        return "#" === e.id
                            ...
                            : "assets/plugins/jstree/demo/" + e.original.file
                    },
                    data: function(e) {
                        return {
                            id: e.id
